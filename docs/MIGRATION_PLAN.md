...
Этот документ описывает план поэтапного приведения всех экранов приложения к единой дизайн-системе,
описанной в `DESIGN_SYSTEM.md`.
...
**Примечание:** Читалка книг имеет собственную стилистику, определяемую настройками книги. Миграция
ограничена общими элементами UI.
