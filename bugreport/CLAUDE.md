...
Модуль `bugreport` предоставляет функционал для отправки пользовательских отчётов об ошибках и
пожеланиях к приложению. Поддерживает отправку через Tracer API и Email.
