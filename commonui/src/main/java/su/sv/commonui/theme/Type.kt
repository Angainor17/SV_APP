...
/**
 * Типографика SV APP
 * Основана на Material Design 3 с настройкой под приложение
 *
 * Использование:
 * - MaterialTheme.typography.bodyLarge
 * - LocalAppTypography.current.bodyLarge
 */
...
val AppTypography = Typography(
    // Display - для больших заголовков на экранах
    ...
    // Title - для заголовков карточек и компонентов
...
// ============================================================
// CUSTOM TEXT STYLES - Дополнительные стили
// ============================================================

/**
 * Дополнительные текстовые стили для специфичных случаев
 */
data class CustomTypography(
    /** Заголовок экрана в тулбаре */
    ...
    /** Текст даты/времени */
    val dateText: TextStyle = TextStyle(
        fontFamily = FontFamily.Default,
        fontWeight = FontWeight.Normal,
        fontSize = 12.sp,
        lineHeight = 16.sp,
    ...
    /** Вспомогательный текст (подписи, hints) */
