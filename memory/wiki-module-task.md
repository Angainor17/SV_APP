...
**Why:** Проект требует отдельного Wiki-модуля для работы со словарём марксизма и диалектики с
поддержкой оффлайн-режима.

**How to apply:** Следовать этапам из wiki_for_CLAUDE_fix.md. После каждого этапа запрашивать
проверку у пользователя.
