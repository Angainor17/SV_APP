...
class RecentCatalogListItem(resource: ZLResource) : NetworkCatalogItem(
    null,
    resource.value,
    ...
    override fun canBeOpened(): Boolean = true // TODO: implement

    @Throws(ZLNetworkException::class)
    override fun loadChildren(loader: NetworkItemsLoader) {
        // TODO: implement
        for (i in 0 until 5) {
            loader.onNewItem(RecentCatalogItem("Catalog $i", "Visited ..."))
        }
