...
static int XMLCALL
external_entity_loader_set_encoding(XML_Parser
parser,
...
if (!
XML_SetEncoding(extparser,
"utf-8"))
fail("XML_SetEncoding() ignored for external entity");
if (
XML_Parse(extparser, text, strlen(text), XML_TRUE
)
== XML_STATUS_ERROR) {
xml_failure(parser);
return 0;
...
static int XMLCALL
external_entity_loader(XML_Parser
parser,
const XML_Char *context,
const XML_Char *base,
const XML_Char *systemId,
...
static int XMLCALL
external_entity_handler(XML_Parser
parser,
const XML_Char *context,
const XML_Char *base,
const XML_Char *systemId,
...
if (
XML_Parse(p2, text, strlen(text), XML_TRUE
) == XML_STATUS_ERROR) {
xml_failure(p2);
return 0;
}
