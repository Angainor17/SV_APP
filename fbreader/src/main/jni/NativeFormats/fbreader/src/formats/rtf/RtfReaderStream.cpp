...
RtfTextOnlyReader::RtfTextOnlyReader(char *buffer, std::size_t maxSize) : RtfReader(std::string()),
                                                                          myBuffer(buffer),
                                                                          myMaxSize(maxSize),
                                                                          myFilledSize(0) {
...
void
RtfTextOnlyReader::insertImage(const std::string &, const std::string &, std::size_t, std::size_t) {
}
...
RtfReaderStream::RtfReaderStream(const ZLFile &file, std::size_t maxSize) : myFile(file),
                                                                            myBuffer(0),
                                                                            mySize(maxSize) {
}
