...
DocReader::DocReader(char *buffer, std::size_t maxSize) : myBuffer(buffer), myMaxSize(maxSize),
                                                          myActualSize(0) {
}
...
DocStream::DocStream(const ZLFile &file, std::size_t maxSize) : myFile(file), myBuffer(0),
                                                                mySize(maxSize) {
}
