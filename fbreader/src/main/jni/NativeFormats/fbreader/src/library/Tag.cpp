...
shared_ptr<Tag>
Tag::cloneSubTag(shared_ptr<Tag> tag, shared_ptr<Tag> oldparent, shared_ptr<Tag> newparent) {
...
Tag::Tag(const std::string &name, shared_ptr<Tag> parent, int tagId) : myName(name),
                                                                       myParent(parent),
                                                                       myLevel(parent.isNull() ? 0 :
                                                                               parent->level() + 1),
                                                                       myTagId(tagId),
                                                                       myJavaTag(0) {
}
