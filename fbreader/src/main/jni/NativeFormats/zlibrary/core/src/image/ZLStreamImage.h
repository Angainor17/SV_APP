...
public:
    ZLStreamImage(const std::string &mimeType, const std::string &encoding, std::size_t offset,
                  std::size_t size = 0);
...
inline ZLStreamImage::ZLStreamImage(const std::string &mimeType, const std::string &encoding,
                                    std::size_t offset, std::size_t size) : ZLSingleImage(mimeType),
                                                                            myEncoding(encoding),
                                                                            myOffset(offset),
                                                                            mySize(size) {}
