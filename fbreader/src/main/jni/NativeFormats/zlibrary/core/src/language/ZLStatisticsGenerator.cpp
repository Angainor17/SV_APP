...
void ZLStatisticsGenerator::generate(const std::string &inputFileName, std::size_t charSequenceSize,
                                     ZLMapBasedStatistics &statistics) {
...
void ZLStatisticsGenerator::generate(const char *buffer, std::size_t length,
