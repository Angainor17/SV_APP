...
public:
    ...
    ZLStatistics(std::size_t charSequenceSize, std::size_t volume,
...
private:
    struct LessFrequency {
        bool operator()(const std::pair<ZLCharSequence, std::size_t> a,
                        const std::pair<ZLCharSequence, std::size_t> b) {
...
public:
    ...
    ZLArrayBasedStatistics(std::size_t charSequenceSize, std::size_t size, std::size_t volume,
                           unsigned long long squaresVolume);
