...
std::string ZLUnicodeUtil::toLower(const std::string &utf8String) {
    ...
    */
    ...
    jstring lowerCased = AndroidUtil::Method_java_lang_String_toLowerCase->callForJavaString(
            javaString);
...
std::string ZLUnicodeUtil::toUpper(const std::string &utf8String) {
    ...
    */
    ...
    JNIEnv *env = AndroidUtil::getEnv();
    jstring javaString = AndroidUtil::createJavaString(env, utf8String);
    jstring upperCased = AndroidUtil::Method_java_lang_String_toUpperCase->callForJavaString(
            javaString);
