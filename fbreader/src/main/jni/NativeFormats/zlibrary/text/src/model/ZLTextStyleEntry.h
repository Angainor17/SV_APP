...
inline ZLTextStyleEntry::ZLTextStyleEntry(unsigned char entryKind) : myEntryKind(entryKind),
                                                                     myFeatureMask(0),
                                                                     myAlignmentType(
                                                                             ALIGN_UNDEFINED),
...
inline ZLTextStyleEntry::Metrics::Metrics(int fontSize, int fontXHeight, int fullWidth,
...
ZLTextStyleEntry::fontFamilies() const { return myFontFamilies; }
