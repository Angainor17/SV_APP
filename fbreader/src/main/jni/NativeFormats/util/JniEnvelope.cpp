...
Field::Field(const JavaClass &cls, const std::string &name, const JavaType &type) : Member(cls),
                                                                                    myName(name) {
...
Method::Method(const JavaClass &cls, const std::string &name, const JavaType &returnType,
               const std::string &parameters) : Member(cls), myName(name) {
...
StaticMethod::StaticMethod(const JavaClass &cls, const std::string &name,
                           const JavaType &returnType, const std::string &parameters) : Member(cls),
                                                                                        myName(name) {
    const std::string signature = parameters + returnType.code();
...
VoidMethod::VoidMethod(const JavaClass &cls, const std::string &name, const std::string &parameters)
        : Method(cls, name, JavaPrimitiveType::Void, parameters) {
}
...
IntMethod::IntMethod(const JavaClass &cls, const std::string &name, const std::string &parameters)
        : Method(cls, name, JavaPrimitiveType::Int, parameters) {
}
...
LongMethod::LongMethod(const JavaClass &cls, const std::string &name, const std::string &parameters)
        : Method(cls, name, JavaPrimitiveType::Long, parameters) {
}
...
BooleanMethod::BooleanMethod(const JavaClass &cls, const std::string &name,
                             const std::string &parameters) : Method(cls, name,
...
StringMethod::StringMethod(const JavaClass &cls, const std::string &name,
                           const std::string &parameters) : Method(cls, name, FakeString,
                                                                   parameters) {
}
...
ObjectMethod::ObjectMethod(const JavaClass &cls, const std::string &name,
                           const JavaClass &returnType, const std::string &parameters) : Method(cls,
                                                                                                name,
                                                                                                returnType,
                                                                                                parameters) {
}
...
ObjectArrayMethod::ObjectArrayMethod(const JavaClass &cls, const std::string &name,
        ...
        : Method(cls, name, returnType, parameters) {
}
