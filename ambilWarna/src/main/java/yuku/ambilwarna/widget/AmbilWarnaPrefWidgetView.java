...
public class AmbilWarnaPrefWidgetView extends View {
    ...
    public AmbilWarnaPrefWidgetView(Context context, AttributeSet attrs) {
        ...
        rectSize = (float) Math.floor(24.f * density + 0.5f); // TODO: voronin check round value
        strokeWidth = (float) Math.floor(1.f * density + 0.5f); // TODO: voronin check round value
